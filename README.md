[index.html](https://github.com/user-attachments/files/25281640/index.html)
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        /* SVG Фильтр для эффекта акварели */
        .watercolor-effect {
            filter: url(#watercolor) contrast(110%) saturate(130%) sepia(20%);
        }
    </style>
</head>
    ...
    <script>
        ...
        const RESULTS = {
            [CAT.HISTORY]: {
                ...
                preview: "https://i.ibb.co/3Wf4gNq/watercolor-building.jpg",
            ...
            [CAT.CREATIVE]: {
                ...
                preview: "https://images.unsplash.com/photo-1565514020176-db99c828d57d?auto=format&fit=crop&q=80&w=800",
            ...
            [CAT.HEALTH]: {
                ...
                preview: "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&q=80&w=800",
                badge: "Медицинский туризм",
                needsFilter: true
            },
            [CAT.SPA]: {
                title: "SPA-комплекс «Богословский»",
                ...
                preview: "https://images.unsplash.com/photo-1519451241324-20b4ea2c4220?auto=format&fit=crop&q=80&w=800",
                badge: "SPA и Релакс",
                needsFilter: true
            },
            [CAT.NATURE]: {
                ...
                preview: "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=800",
                badge: "Эко-туризм",
                needsFilter: true
            }
        };
        ...
        function renderStartScreen() {
            return `
            <div class="flex flex-col h-full p-6 justify-between animate-fade-in bg-white">
                <div class="mt-8">
                    ${getLogoHTML()}
        ...
        function renderQuizScreen() {
            ...
            return `
            <div class="flex flex-col h-full p-6 animate-slide-in bg-white">
        ...
        function renderResultScreen() {
            ...
            // Формируем стили для фото (фильтр)
            const filterClass = result.needsFilter ? 'watercolor-effect' : '';
            const imgStyle = result.needsFilter ? 'transform: scale(1.05);' : '';

            return `
            <div class="flex flex-col h-full bg-white animate-fade-in overflow-y-auto">
                <div class="p-6 pb-0">
                    ${getLogoHTML()}
                </div>
                ...
                <div class="p-6 flex flex-col flex-1">
                    ...
                    <div class="relative w-full h-56 rounded-2xl overflow-hidden mb-6 shadow-md bg-gray-100 border border-gray-100">
                        <img 
                            ...
                            onerror="this.onerror=null;this.src='${result.preview}';"
                            alt="${result.title}" 
                            class="w-full h-full object-cover transition-all duration-700 ${filterClass}"
                            style="${imgStyle}"
                        />
